const music = [
    ...
    {
    title: 'UNFORGIVEN (feat. Nile Rodqers)',
    ...
    {
    title: 'Angel Pt. 1 (Feat. Kodak Black, NLE Choppa, JVKE, Muni Long)',
    artist: '지민'
    },
    {
    title: 'TOMBOY',
    ...
    {
    title: 'Dreamers [Music from the FIFA World Cup Qatar 2022 Official Soundtrack] (Feat. FIFA Sound)',
    artist: '정국, 방탄소년단'
    },
    {
    ...
    {
    title: '한사람만 (2023) (여름날 우리 X 이홍기 (FT아일랜드))',
    artist: '이홍기 (FT아일랜드)'
    },
    {
